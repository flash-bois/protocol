  ...
  const sig = await program.methods
    ...
    .postInstructions([
      ...
      await program.methods
        ...
        .instruction(),
      await program.methods
        .modifyFeeCurve(index, 2, true, new BN(300000), new BN(0), new BN(10000), new BN(10000))
        .accounts(accounts)
        .signers([admin])
        .instruction(),
      await program.methods
        ...
        .instruction(),
      await program.methods
        .modifyFeeCurve(index, 2, false, new BN(300000), new BN(0), new BN(10000), new BN(10000))
        .accounts(accounts)
        .signers([admin])
        .instruction(),
      await program.methods
        ...
        .instruction(),
      await program.methods
        .addStrategy(index, true, false, false, new BN(800_000), new BN(850_000)) ///// STRATEGIES
        .accounts(accounts)
        .signers([admin])
        .instruction(),
      await program.methods
